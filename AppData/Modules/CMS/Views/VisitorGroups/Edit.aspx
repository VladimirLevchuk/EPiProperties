...
(function() {
    ...
    dojo.require("epi.cms.form.ValidationError");
    ...
    dojo.addOnLoad(function() {
        ...
        document.getElementById('saveButton').onclick = function(evt) {
            ...
            var validationErrors = new epi.cms.form.ValidationError();
            ...
            dojo.forEach(aTarget.getAllNodes(), function(domNode) {
                ...
                if (plugin && plugin.validate) {
                     ...
                     if(pluginErrors instanceof epi.cms.form.ValidationError) {
            ...
            self._loadUI(namingContainerPrefix, container, function(){
                ...
                self._loadModelDefinition(function() {                      
                    ...
                    for(var i in self.definition){
                        ...
                        dojo.require(p.DojoPackage || p.DojoType);

                        var widgetClass = dojo.getObject(p.DojoType);
                        var options = {};
