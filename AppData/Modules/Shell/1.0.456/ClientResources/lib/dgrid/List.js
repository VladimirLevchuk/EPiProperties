			...
			if(results.observe){
				...
				var observerIndex = this.observers.push(results.observe(function(object, from, to){
					...
					if(to > -1){
						...
						//The logic to get row here has changed compared to the original version(dgrid 0.3.1) 
						//to fix next node logic for dgrid so that it work correctly with tree plugin
